function[ CLUSTER , SAMPLE_FOR_CLUSTER , SINGLE_POINT , FLAG_ANY_FIND_CLUSTERRING ,  test] =  CLUSTERRING_OPTIMUM_2_NEW_1 (SAMPLE , CLUSTER , SAMPLE_FOR_CLUSTER , SINGLE_POINT , SAMPLE_TOTAL , X_BIG ,  TH_ANGLE , TH_DIS , CLASS_NUMBER , TH_ANGLE_FIRST , TH_DIS_FIRST  )
...
%     a = SAMPLE_TOTAL(i,:)
%     X_BIG
    if ((round(SAMPLE_TOTAL(i,2)) == round(X_BIG(1)) ) &&  (round(SAMPLE_TOTAL(i,3)) == round(X_BIG(2) )))  
            eliminate_row = i;
%             note='find'
%             pause
            break;
