...
a=imread  ( 'E:\mat\image\Untitled3.png');
b=rgb2gray(a);
x=double(b);
...
dtt=dt;
  ...
  r_optimum = 1076 ;                       %% initialize row for priori estimate   (pixel)
 c_optimum = 693;                         %% initialize column for  priori estimate (pixel))
 r_opt = r_optimum ;
 r_opt = r_optimum ;
c_opt = c_optimum ; 
...
flag_gradient5 = 1 ;
note = ' error is bad or condidate point put on edge in situation gradient5 '
end  %% end gradient5
...
flag_gradient6 = 1 ;
note = ' error is bad or condidate point put on edge in situation gradient6 '
end  %% end gradient6

if (flag_gradient5 ==1) && ( flag_gradient6 ==1)
    flag_gradient = 1;
else
    flag_gradient = 0;
end
...
if (round(c_optimum) == 565) && ( round(r_optimum) == 43   )
    break
    note = 'break'
end
