...
c_opt = c_optimum ; 
 ...
 p_1 =[168 , 170 , 169 , 171 , 167 , 168 , 170 , 169 , 170]         %% initialize reference profile
 p_2 = p_1 -10;
 p_3 = p_1 -20;
 p_4 = p_1 - 30;
 ...
 contrast_match = 220;                %% firm value for cluster contrast (gray level )
 contrast_road = 100;                   %% firm value for road contrast ( gray level )
...
%          0 , 0  , dtt/2 , 1 ] ;                                                                                                                                                                     %% covariance of system ( second senario ) - in thesis
    ...
    C_opt=150;                                   %% i assumed that my first wide of road is ....
    q=1;
    AA=1:9;
    reg = 0 ; 
    p_com_angle = 1000;
