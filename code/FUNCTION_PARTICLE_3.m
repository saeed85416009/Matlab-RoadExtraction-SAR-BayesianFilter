function FUNCTION_PARTICLE_3( R_OPTIMUM , C_OPTIMUM , ANGLE , GRAY_ELIMINATE , WIde , CONDITION , D_PARTICLE , ITERATION )
...
%                           s=samp(i,:)
                ...
                if( x(round(samp(i,1)),round(samp(i,2))) <=  th_gray_eliminate ) && ( samp(i,1) > 1) && (edge_canny(round(samp(i,1)),round(samp(i,2))) <=  contrast_road )  %% eliminate rand point of out road 
