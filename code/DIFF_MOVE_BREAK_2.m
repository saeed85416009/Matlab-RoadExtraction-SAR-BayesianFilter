...
function [ T , flag_unacceptive ] = DIFF_MOVE_BREAK_2 ( ROW , COLOUMN , ANGLE , CONTRAST_ROAD ,  MAX_WIDE_ROAD)

global edge_canny
global M
global N
global unaceptive_sample
...
%% move left of center
       ...
       R_5 = 0;
       R_5(1,i) = 0;
      size_unaceptive_point =size(unaceptive_sample);
      flag_unacceptive = 0;
while    (R_1 ( 1 , i )  < CONTRAST_ROAD) &&   (R_2 ( 1 , i )  < CONTRAST_ROAD) && (R_3 ( 1 , i )  < CONTRAST_ROAD)  && (R_4 ( 1 , i )  < CONTRAST_ROAD) && (R_5 ( 1 , i )  < CONTRAST_ROAD)       
        ...
        c_4 = COLOUMN + u *cosd ( ANGLE );
         ...
         for s_u = 1: size_unaceptive_point(1)
            if (round(r_4) == round(unaceptive_sample(s_u , 1)))  &&  (round(c_4) == round(unaceptive_sample(s_u , 2) ))
