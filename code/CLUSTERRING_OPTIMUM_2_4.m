function [ CLUSTER , SAMPLE_FOR_CLUSTER , FLAG_ANY_FIND_CLUSTERRING ,  test] =  CLUSTERRING_OPTIMUM_2_4 (SAMPLE , CLUSTER , SAMPLE_FOR_CLUSTER , X_BIG , ANGLE ,  TH_ANGLE , TH_DIS , CLASS_NUMBER , TH_ANGLE_FIRST )
...
for fi = ANGLE - TH_ANGLE_FIRST : ANGLE + TH_ANGLE_FIRST
    ...
    r_4 =  source_cluster(clus,2) - dis * sind ( fi )  ; 
    c_4 =  source_cluster(clus,3) + dis * cosd ( fi );
...
%                        pause
                        ...
                        if  flag_duplicate_clus == 0 %% if point not duplicate 
                            ...
                            clus = clus+1;
                            source_cluster(clus,1) = CLASS_NUMBER;  %% class number
                             source_cluster(clus,2) = source_cluster(s_c,2);
                            source_cluster(clus,3) = source_cluster(s_c,3);
