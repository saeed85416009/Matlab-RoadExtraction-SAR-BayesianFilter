...
% FUNCTION_PARTICLE_5( r_optimum , c_optimum , angle_old , gray_eliminate , 4 , detour , 4 , 0.1 ,  1 )
% 
% for fi = 100:180
%     
%     r_4 =  127.8886 - 2.4 * sind ( fi )   
%     c_4 =  123.2907 + 2.4 * cosd ( fi )
%     pause
% end
% 
% r=x;
