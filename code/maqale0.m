...
a=imread  ( 'E:\mat\image\Untitled.png');
x=double(a);
...
dtt=dt;
 ...
 r_optimum = 40 ;                       %% initialize row for priori estimate   (pixel)
 c_optimum = 48;                         %% initialize column for  priori estimate (pixel)
 r_opt = r_optimum ;
 r_opt = r_optimum ;
c_opt = c_optimum ; 
 ...
 p_1 =[255 255 254]         %% initialize reference profil
