...
dtt=dt;
 ...
 r_optimum = 514 ;                       %% initialize row for priori estimate   (pixel)                    %%---**---%%
 c_optimum = 31;                         %% initialize column for  priori estimate (pixel)                %%---**---%%
 r_opt = r_optimum ;
c_opt = c_optimum ; 
...
p_1 =[47 46 45 ];       %% initialize reference profile                  %%---**---%%
...
imshow(uint8(edge_canny))
 ...
 WMM = 9*W/4;                           %% Wide Margin for Matching
 CG = 200;                                  %% Cut Gradient
