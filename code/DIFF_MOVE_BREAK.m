...
function [ T , flag_unacceptive ] = DIFF_MOVE_BREAK ( ROW , COLOUMN , ANGLE , CONTRAST_ROAD ,  MAX_WIDE_ROAD)
...
while    (R_1 ( 1 , i )  < CONTRAST_ROAD) &&   (R_2 ( 1 , i )  < CONTRAST_ROAD) && (R_3 ( 1 , i )  < CONTRAST_ROAD)  && (R_4 ( 1 , i )  < CONTRAST_ROAD) && (R_5 ( 1 , i )  < CONTRAST_ROAD)       
        ...
        for s_u = 1: size_unaceptive_point(1)
            if (round(r_4) == round(unaceptive_point(s_u , 1)))  &&  (round(c_4) == round(unaceptive_point(s_u , 2) ))
