...
particle_new_column = c_optimum ; 
 ...
 th_angle_merge_cluster = th_angle_particle_1 ;  %degree  ( use in merge clster)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 class_number =1;
 angle = ( x_0(3) * 180)/pi ;
 [clusterring , sample_for_cluster , flag_find_clusterring ] = CLUSTERRING_OPTIMUM_2_1 (sample_for_cluster  , clusterring , sample_for_cluster , x_0 , angle , th_angle_particle_2, th_distance_clusterring , class_number );
  note='check'
  pause
...
sample_for_cluster = MEDIAN_ANGLE (sample_for_cluster , 9 , 12)   
sample_t
sample_for_cluster
