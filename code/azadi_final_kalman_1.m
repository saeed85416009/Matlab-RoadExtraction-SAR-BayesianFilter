...
a=imread  ( 'E:\internet\uni\proje\matlab\image\azadi.jpg');    %%---**---%%
b=rgb2gray(a);
x=double(b);
level = graythresh(b)
...
max_profile = 120;                       %%---**---%%    %% this point show when point out of road
 ...
 p_1 =[63 60 59 57 58 58 58 60 59 60 63 ];        %% initialize reference profile                  %%---**---%%
...
imshow(uint8(edge_canny))
 ...
 CSM = 6;                                   %% Cluster Similarity Modify ( regulation similarity between clusters )  ( pixel )       %%---**---%%
...
th_pixel_car = 2;                           %% maximum lengh of car in the picture     %%---**---%%
