...
dtt=dt; 
 ...
 r_optimum = 118 ;                       %% initialize row for priori estimate   (pixel)
 c_optimum =138;                         %% initialize column for  priori estimate (pixel)
 r_opt = r_optimum ;
 r_opt = r_optimum ;
c_opt = c_optimum ; 
...
if (round(c_optimum) == 297) && ( round(r_optimum) == 40    )
    break
end
