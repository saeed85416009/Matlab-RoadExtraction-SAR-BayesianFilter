...
IMSHOW_IMAGE_2(remain , 2 , 3 , 1 )
     ...
     angle = ( x_total(class , 3) * 180)/pi 
      ...
      pause
      if time ==1
     [clusterring , sample_f_c , flag_find_clusterring ] = CLUSTERRING_OPTIMUM_3_1_3 (remain  , remain_ext , clusterring , sample_f_c , sample_for_cluster , x_total( class , : ) , angle , th_angle_particle_1, th_distance_clusterring , class , th_angle_particle_first_time , th_dis_particle_first_time  );
      else
    [clusterring , sample_f_c , flag_find_clusterring ] = CLUSTERRING_OPTIMUM_3_2_1 (remain  , remain_ext , clusterring , sample_f_c , sample_for_cluster , x_total( class , : ) , angle , th_angle_particle_1, th_distance_clusterring , class , th_angle_particle_first_time , th_dis_particle_first_time );
      end
     clusterring
