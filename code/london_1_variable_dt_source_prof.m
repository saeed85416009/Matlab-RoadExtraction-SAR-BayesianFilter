...
%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 CG = 200;                                  %% Cut Gradient
 contrast_road = 100;                  %% firm value for road contrast in gradient state for moving in point ( gray level )
 ...
 var_mean_good = 300;               %% maximum variance that my condidate point profile can be have if all of ingredient of profile less than source profile
 var_mean_bad = 200;                  %% maximum variance that my condidate point profile can be have if few of ingredient of profile more than source profile
...
if (round(c_optimum) == 109) && ( round(r_optimum) == 1550   )
    break
    note = 'break'
end
