...
a=imread  ( 'E:\mat\dey\image\sanaa.jpg');
x=double(a);
...
dtt=dt;
 ...
 r_optimum = 1578 ;                       %% initialize row for priori estimate   (pixel)
 c_optimum = 652;                         %% initialize column for  priori estimate (pixel)
 r_opt = r_optimum ;
 r_opt = r_optimum ;
c_opt = c_optimum ; 
 ...
 p_1 =[55,56,55,55,52,51,50,54,58]         %% initialize reference profil
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 var_max_cluster = 150;              %% maximmum variance that cluster can be have
 gradient_wide = W/10 ;
