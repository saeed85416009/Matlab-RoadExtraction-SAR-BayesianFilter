function FUNCTION_KALMAN(R_OPTIMMUM , C_OPTIMMUM , ANGLE , WIDE , TH_MAX_GRAY, D_STRAIGHT , D_CURVE , SOURCE_PROFILE , iteration_intersection_particle , iteration_detour_particle)
%%
...
%           unaceptive_point
          break;
            ...
            Angle
                    ...
                    pause
                        FUNCTION_PARTICLE_3( r_optimum , c_optimum , angle_old , gray_eliminate , WIDE , detour , 4 , iteration_detour_particle )
                    continue
                end
                %%%%%%%%%%%%%%%%%%%%%%%
...
%                    0 , 0 , ( sigma_fio  )  ]  ;                                                   %% measurment covariance ( second senario ) - in thesis
 ...
 %%
flag_exchange_particle = FIND_BREAK_POINT_2( r_optimum , c_optimum , angle , gray_eliminate , wide , iteration_intersection_particle);
