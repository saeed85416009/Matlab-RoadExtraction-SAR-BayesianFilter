...
c_opt = c_optimum ; 
 ...
 angle =-15 ;                                        %% initialize angle of road ( degree )
 ...
 contrast_road = 10;                   %% firm value for road contrast ( gray level )
...
%%% that with old cluster. 
 ...
 %%% measurment wide of road 
    ...
    while  (( R_4(1,i) - R_4(1,i-1) ) < contrast_road)
       r_4 = round ( r_optimum + u *sind (90-angle ));    
       c_4 = round ( c_optimum + u *cosd ( 90-angle ));
