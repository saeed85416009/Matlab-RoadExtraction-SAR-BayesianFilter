...
%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 var_max = 300;                          %% maximmum variance that profile can be have
...
if flag_gradient == 0 
    ...
    %%% detect wrong point %%%
if ( gradient_wide5 < ( gradient_wide /2 ) ) && ( abs(fi-angle) > T_angle )
    C5 = 1000;
end
 if ( gradient_wide6 < ( gradient_wide /2 ) ) && ( abs(fi-angle) > T_angle )
    C6 = 1000;
end
%%%%%%%%%%%%%%%%
...
if (round(c_optimum) == 149) && ( round(r_optimum) == 571    )
    break
end
