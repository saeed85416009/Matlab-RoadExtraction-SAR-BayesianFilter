function FUNCTION_PARTICLE_4( R_OPTIMUM , C_OPTIMUM , ANGLE , GRAY_ELIMINATE , WIde , CONDITION , D_PARTICLE , ERROR_KALMAN , ITERATION )
...
particle_new_column = c_optimum ; 
 ...
 B=1;
 test_number =0;
 th_angle_measurement_final_point = 180;
 %%%
...
% pause
 ...
 for j=1: k
                 ...
                 if edge_canny(round(sample_t(j,2)),round(sample_t(j,3)) )< contrast_road 
                     ...
                     [z_particle(j,1) , z_particle(j,2) , z_particle(j,3) , z_particle(j,4) , flag_intersect] = MEASUREMENT_PARTICLE(sample_t(j,2) , sample_t(j,3)  , contrast_road , WMM , angle_sample_weight , th_angle_measurement , th_angle_measurement_intersection , WIde   );
                 else
 ...
 x_total_final = CREATE_FINAL_X( sample_total );
   ...
   for class = 1 : class_number_new
            ...
            angle_sample_weight = x_total_final(class,4)*180/pi;
             [z_particle(class,1) , z_particle(class,2) , z_particle(class,3) ] = MEASUREMENT_PARTICLE(x_total_final(class,2) , x_total_final(class,3)  , contrast_road , WMM , angle_sample_weight , th_angle_measurement , th_angle_measurement_intersection , WIde   );
             else
 ...
 switch CONDITION
     ...
     case intersection
         ...
         for i = 1 : ss
                 ...
                 [ r , c] = MEASUREMENT_PARTICLE( final_point_particle(i,2) , final_point_particle(i,3)  ,contrast_road , WMM , angle_sample_weight , th_angle_measurement_final_point , th_angle_measurement_final_point , WIde   );
     ...
     case detour
         ...
         for i = 1 : ss
                ...
                angle_sample_weight = final_point_particle(i,4)*180/pi;
                 [ r , c] = MEASUREMENT_PARTICLE( final_point_particle(i,2) , final_point_particle(i,3)  ,contrast_road , WMM , angle_sample_weight , th_angle_measurement_final_point , th_angle_measurement_final_point , WIde   );
