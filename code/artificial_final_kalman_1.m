...
max_profile = 250;                       %%---**---%%    %% this point show when point out of road
...
imshow(uint8(edge_canny))
 ...
 CSM = 5;                                   %% Cluster Similarity Modify ( minimum regulation similarity between clusters )  ( pixel )       %%---**---%%
