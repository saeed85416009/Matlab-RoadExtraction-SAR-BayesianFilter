function   SAMPLE_FOR_CLUSTER = CREATE_SAMPLE_FOR_CLUSTERRING_2 ()
...
global sample_t
 ...
 for ss = 1:s_s(1)
     ...
     if sample_t(ss,2) ~= 0
        ...
        %%% measurement
        SAMPLE_FOR_CLUSTER (ss_c , 7 ) = sample_t(ss,2);
        SAMPLE_FOR_CLUSTER (ss_c , 8 ) = sample_t(ss,3);
        SAMPLE_FOR_CLUSTER (ss_c , 9 ) = sample_t(ss,4);
