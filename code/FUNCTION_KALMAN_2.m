function FUNCTION_KALMAN_2(R_OPTIMMUM , C_OPTIMMUM , ANGLE , WIDE , TH_MAX_GRAY, D_STRAIGHT , D_CURVE , SOURCE_PROFILE , iteration_intersection_particle , iteration_detour_particle)
%%
...
if  ( abs(e) < abs(e_opt) && ( edge_canny(r_2,c_2) < max_canny )  )
                    ...
                    %       C
                          ...
                          if abs_angle > 180
                            ...
                            if ( edge_canny_wide_C < ( edge_canny_wide ) ) && ( abs_angle > T_angle )                                C = 1000;
                                flag_edge_canny = 1 ;
                                note = ' point in hole situation'
                            end
                          %%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     [bad_wmm , bad_wmm ] = find( Diff < C_optima);
        ...
        WMM = WMM_normal;
                ...
                if reg == 0
                    ...
                    pause
                        FUNCTION_PARTICLE_5( r_optimum , c_optimum , angle_old , gray_eliminate , WIDE , detour , 4 , error_kalman , iteration_detour_particle )
                        UNACCEPTANCE_POINT( angle , r_optimum , c_optimum , wide )
                                fo =0;
                                fo_optimum =0;
