...
%           end
 ...
 class_number =1;
 angle = ( x_0(3) * 180)/pi ;
 [clusterring , sample_for_cluster , flag_find_clusterring ] = CLUSTERRING_OPTIMUM_2 (sample_for_cluster  , clusterring , sample_for_cluster , x_0 , angle , th_angle_particle_1, th_distance_clusterring , class_number );
...
%      note = ' ############################################################################################'
%    pause  
 [ x_new , flag_find_new_point , angle] = FIND_SOURCE_POINT_FOR_NEW_CLUSTER ( remain_clusterring , clusterring ,  x_0 , th_angle_new_point , 1 , th_forward_dis , th_angle_particle_1 );
 
    if flag_find_new_point ~= 0
        th_angle_new_point_negative = - th_angle_new_point;
        [ x_new , flag_find_new_point , angle  ] = FIND_SOURCE_POINT_FOR_NEW_CLUSTER ( remain_clusterring , clusterring , x_0 , th_angle_new_point_negative , -1 , th_forward_dis , th_angle_particle_1 );
    end
...
if flag_find_new_point == 0
 [clusterring , sample_for_cluster , flag_find_clusterring ] = CLUSTERRING_OPTIMUM_2 (remain_clusterring  , clusterring , sample_for_cluster , x_new , angle , th_angle_particle_2, th_distance_clusterring , class_number );
end
...
pause
     ...
     [clusterring , sample_f_c , flag_find_clusterring ] = CLUSTERRING_OPTIMUM_3 (remain  , clusterring , sample_f_c , x_total( class , : ) , angle , th_angle_particle_1, th_distance_clusterring , class );
  clusterring
  pause
 ...
 pause
  ...
  sample_f_c = MATCHING_REPETITIVE_CLUSTERRING( sample_for_cluster , class );
    clusterring_class = MATCHING_REPETITIVE_CLUSTERRING ( clusterring , class );
     ...
     clusterring_sum =[];
    size_clusterring_s = size(clusterring_sum);
    size_clusterring_c = size(clusterring_class);
            if size_clusterring_c ~= 0
                kp=0;
                for s_D = size_clusterring_s(1)+1 :  size_clusterring_s(1)+size_clusterring_c(1)
                    kp=kp+1;
                    for yu=1:10
                         clusterring_sum(  s_D , yu ) = clusterring_class(kp,yu) ;
                    end
                end
            end
    ...
    clusterring_class = MATCHING_REPETITIVE_CLUSTERRING ( clusterring , class );
         ...
         while( size(remain_clusterring) > 0  )
             ...
             %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                             ...
                             class_number = class_number +1;
                             BB=B+1;
                             B=size(clusterring_class);

                             gray_class = gray_class - 12.5;

                           for i =BB:B

                                          class1(round(clusterring_class(i,7)) , round(clusterring_class(i,8) ) ) = gray_class;
                           end
                                 figure(3)
                             imshow(uint8(class1))
                             end
         ...
         [ remain_clusterring , flag_finish_remain ]= REMAIN_CLUSTERRING_2 ( sample_f_c , clusterring_class  )
          ...
          [ x_new , flag_find_new_point , angle] = FIND_SOURCE_POINT_FOR_NEW_CLUSTER_2 ( remain_clusterring , clusterring_class ,  x_total( class , : ) , th_angle_new_point , 1 , th_forward_dis , th_angle_particle_1 );
       
                    
          if flag_find_new_point ~= 0
                th_angle_new_point_negative = - th_angle_new_point;
                [ x_new , flag_find_new_point , angle] = FIND_SOURCE_POINT_FOR_NEW_CLUSTER_2 ( remain_clusterring , clusterring_class ,  x_total( class , : ) , th_angle_new_point_negative , -1 , th_forward_dis , th_angle_particle_1 );
         end
                ...
                if flag_find_new_point == 0
                           [clusterring_class , sample_f_c , flag_find_clusterring ] = CLUSTERRING_OPTIMUM_4 (remain_clusterring  , clusterring_class , sample_f_c , x_new , angle , th_angle_particle_1, th_distance_clusterring , class_number );
                end
