...
%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 WMM = 11*W/4;                           %% Wide Margin for Matching
 CG = 200;                                  %% Cut Gradient
 contrast_road = 110;                  %% firm value for road contrast in gradient state for moving in point ( gray level )
 max_grad = contrast_road;                       %% maximum gradian that my measurment point can be value
 SA = 4500;                                   %% Stop Algorithm
...
th_car = 200 ;                               %% threshoul value for detect car in the road
...
if (round(c_optimum) == 276) && ( round(r_optimum) == 440  )
    break
    note = 'break'
end
