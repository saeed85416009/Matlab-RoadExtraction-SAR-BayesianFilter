function [ Z_PARTICLE_ROW , Z_PARTICLE_COLOUMN, ANGLE ,  move , FLAG_INTERSECT] = MEASUREMENT_PARTICLE( ROW_PARTICLE , COLOUMN_PARTICLE  , CONTRAST_PR , WIDE_MARGIN , ANGLE_SAMPLE , TH_ANGLE , WIDE_MARGIN_EDGE , WIDE  )
...
for fi = ANGLE_SAMPLE - TH_ANGLE : ANGLE_SAMPLE + TH_ANGLE
    ...
    [C , edge_canny_wide_C , C1 , C2]  = DIFF_PARTICLE_3 ( ROW_PARTICLE ,COLOUMN_PARTICLE  , fi , CONTRAST_PR ,  WIDE_MARGIN);
