...
dtt=dt;
 ...
 r_optimum = 197 ;                       %% initialize row for priori estimate   (pixel)                    %%---**---%%
 c_optimum = 363;                         %% initialize column for  priori estimate (pixel)                %%---**---%%
...
particle_new_column = c_optimum ; 
 ...
 th_gray_eliminate = 60;  %% eliminate point that put over of road
