function FUNCTION_PARTICLE_5( R_OPTIMUM , C_OPTIMUM , ANGLE , GRAY_ELIMINATE , WIde , CONDITION , D_PARTICLE , ERROR_KALMAN , ITERATION )
...
%   sample
  ...
  figure(2) 
   IMSHOW_IMAGE_KALMAN(sample,1,2,2)
%  pause
